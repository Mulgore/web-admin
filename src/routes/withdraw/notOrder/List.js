...
const withdrawType = (key) => {
  switch (key){
    case -1:
      return <Button style={{ color:'#00a854' }} type="dashed">手动提现</Button>
    case 0:
      return <Button style={{ color:'#00a854' }} type="dashed">D + 0</Button>
    default:
      return <Button style={{ color:'#108ee9' }} type="dashed">T + {key -1}</Button>
  }
}
