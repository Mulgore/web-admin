    ...
    <div className={styles.sales}>
      ...
      <ResponsiveContainer minHeight={360}>
        <LineChart data={data}>
          ...
          />
          {/*<Line type="monotone" dataKey="交易量" stroke={color.purple} strokeWidth={3} dot={{ fill: color.purple }} activeDot={{ r: 5, strokeWidth: 0 }} />*/}
